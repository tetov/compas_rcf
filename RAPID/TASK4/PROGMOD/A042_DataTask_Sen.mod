MODULE A042_DataTask_Sen
    ...
    !
    TASK PERS num n_A042_ReadPtrSenBufRob{n_A042_NumOfCha}:=[1,1,1,1];
    TASK PERS num n_A042_ReadPtrSenBufMa{n_A042_NumOfCha}:=[1,1,1,1];
    !
    TASK PERS num n_A042_SenHeaderSqzNr{n_A042_NumOfCha}:=[0,0,0,0];
    !
    TASK PERS num n_A042_SenMsgLenRob:=62;
    !
    TASK PERS num n_A042_TimeStamp:=31.954;
    TASK PERS num n_A042_TimeStampSec:=31;
    TASK PERS num n_A042_TimeStampNanoSec:=954;
