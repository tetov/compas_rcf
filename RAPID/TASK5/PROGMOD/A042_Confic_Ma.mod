MODULE A042_Confic_Ma
    ...
    ! **************** ETH Zürich *******************
    !
    PROC r_A042_A042_Config()
        !
        ! Tasklists 
        tl_A042_All:=[["T_MASTER"],["RECEIVER"],["SENDER"],["T_ROB11"],["T_ROB12"],[""],[""]];
        !
        ! Channel 1
        ch_A042_Channels.Ch_1.T_Name:="T_ROB11";
        ch_A042_Channels.Ch_1.Ch_Nr:=1;
        !
        ! Channel 2
        ch_A042_Channels.Ch_2.T_Name:="T_ROB12";
        ch_A042_Channels.Ch_2.Ch_Nr:=2;
        !
        ! Channel 3
        ch_A042_Channels.Ch_3.T_Name:="T_ROB21";
        ch_A042_Channels.Ch_3.Ch_Nr:=3;
        !
        ! Channel 4
        ch_A042_Channels.Ch_4.T_Name:="T_ROB22";
        ch_A042_Channels.Ch_4.Ch_Nr:=4;
        !
        ! IP Address
        b_A042_AutoIPAddress:=TRUE;
        st_A042_IP_AddressMan:="192.168.0.21";
        !
        ! Ports 
        ...
        !
        ! Roboter 2
        b_A042_Com{n_A042_R2_ChaNr}:=TRUE;
