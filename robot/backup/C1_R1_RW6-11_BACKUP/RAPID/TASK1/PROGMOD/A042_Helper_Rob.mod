MODULE A042_Helper_Rob
    ...
    !************************************************
    !
    TASK PERS bool b_A042_StoJoToArryOn:=FALSE;

    !************************************************
    ! Declaration :     num
    !************************************************
    !
    TASK PERS num n_A042_ArryPointer:=1;

    !************************************************
    ! Declaration :     jointtarget
    !************************************************
    !
    TASK PERS jointtarget jp_A042_Arry{51}:=[
    ...
    !***************** ETH Zürich *******************
    !
    PROC r_A042_StoJoPosInArry()
        !
        ! Made always a fine point 
        WaitRob\InPos;
        !
        ! Increase arry pointer
        Incr n_A042_ArryPointer;
        !
        ! Read current position
        jp_A042_Arry{n_A042_ArryPointer}:=CJointT();
        ! Placehoder for Code
        RETURN ;
    ERROR
    ...
    !***************** ETH Zürich *******************
    !
    PROC r_A042_ExeJoPosFromArry()
        !
        n_A042_ArryPointer:=1;
        !
        WHILE n_A042_ArryPointer<=51 DO
            MoveAbsJ jp_A042_Arry{n_A042_ArryPointer},vmax,z200,tool0;
            ! Increase arry pointer
            Incr n_A042_ArryPointer;
        ENDWHILE
        !
