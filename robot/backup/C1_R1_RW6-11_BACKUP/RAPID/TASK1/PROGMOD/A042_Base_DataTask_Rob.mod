MODULE A042_Base_DataTask_Rob
    ...
    TASK PERS string st_A042_TPWrite:="Last cycle time was: 35";
    ...
    TASK PERS speeddata v_A042_Act:=[4200,500,5000,1000];
    ...
    !************************************************
    !  
    TASK PERS robtarget p_A042_Act:=[[1098.76,862.705,412.964],[-0.061445,-0.197496,0.936768,0.282287],[-2,0,0,0],[0,0,0,9E+09,9E+09,9E+09]];
